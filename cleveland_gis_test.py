...
for feature in data.get("features", []):
    ...
    print("Deeded Acres:", attr.get("GIS_Deeded_Acres"))
    print("Calculated Acres:", attr.get("GIS_Calculated_Acres"))
